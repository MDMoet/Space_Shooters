...
namespace Eindopdracht.classes
{
    public class UserActions
    {
        public class Movement
        {
            ...
            public static void Move(Border user, Direction direction)
            {
        ...
        public class Attack
        {
            public static void Attack1(Border user, Grid MainGrid)
            {
                // Attack 1 logic
            ...
            public static async void MoveAttack(Border Laser1, Border Laser2, Grid MainGrid)
            {
                while (Laser1.Margin.Top > -875 && Laser2.Margin.Top > -875) {
                    if (Paused)
                    {
